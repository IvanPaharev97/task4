...
public class PutIntPropertyStaxCommand extends StaxHandlerCommand implements Command {

    public PutIntPropertyStaxCommand(TreasureStaxHandler treasureStaxHandler) {
