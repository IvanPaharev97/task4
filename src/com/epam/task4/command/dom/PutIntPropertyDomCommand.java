...
public class PutIntPropertyDomCommand extends DomHandlerCommand implements Command {

    public PutIntPropertyDomCommand(TreasureDomHandler treasureDomHandler) {
